<?php
//Template Name: cosmetic denstry
?>
<?php get_header(); ?>
<style>
    .hero-section {
...
<div class="elementor-element elementor-element-a2d7d7c elementor-widget elementor-widget-theme-post-content"
    ...
    <div class="elementor-widget-container">
        <div data-elementor-type="wp-page" data-elementor-id="31" class="elementor elementor-31"
            ...
            <section class="hero-section" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/shutterstock_524429965.jpg');">
                <div class="overlay"></div>
                <div class="hero-content">
                    <div class="heading-strip-full">
                        <h1 class="elementor-heading-title">You Deserve a Smile That Is a True Reflection of You</h1>
                    </div>
                </div>
            </section>
                                    ...
                                    <a href="<?php the_permalink(); ?>" class="text-decoration-none d-block h-100">
                                        <div class="card h-100 border-0 shadow-sm">
                                            <?php if (has_post_thumbnail()) : ?>
                                                <?php the_post_thumbnail('large', ['class' => 'card-img-top', 'alt' => get_the_title()]); ?>
                                            <?php endif; ?>
                                            <div class="card-body p-5" style="background: #94b8c6;">
                                                <h5 class="card-title text-white fw-semibold text-capitalize mb-3" style="letter-spacing:0; font-size: 22px;">
                                                    <?php the_title(); ?>
                                                </h5>
