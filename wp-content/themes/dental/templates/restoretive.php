<?php
//Template Name: resortive denstry
?>
<?php get_header(); ?>
<style>
    .hero-section {
...
<div class="elementor-element elementor-element-a2d7d7c elementor-widget elementor-widget-theme-post-content"
    ...
    <div class="elementor-widget-container">
        <div data-elementor-type="wp-page" data-elementor-id="31" class="elementor elementor-31"
            ...
            <section class="hero-section" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/shutterstock_130453604.jpg');">
                <div class="overlay"></div>
                <div class="hero-content">
                    <div class="heading-strip-full">
                        <h1 class="elementor-heading-title">You Deserve To Smile With Confidence</h1>
                    </div>
                </div>
            </section>
            ...
            <section class="py-5 bg-light" id="advanced-technology">
                <div class="container">
                    <h2 class="text-center mb-5">All Restorative Dental Options</h2>
                    <?php
                    $args = array(
                        'post_type'      => 'services',
                        'posts_per_page' => -1,
